...
class PlantLoopRangeland(ScenarioBase):
    def __init__(self, lines, root):
        ...
        self.pltol = float(line.pop(0))
        self.pscday = parse_julian(line.pop(0))
        ...
        self.scday2 = parse_julian(line.pop(0))
...
class SurfLoopCropland(ScenarioBase):
    def __init__(self, lines, root):
        self.root = root
        self.mdate = parse_julian(lines.pop(0))
...
class YearLoopCroplandAnnualFallowHerb(ScenarioBase):
    def __init__(self, lines, root):
        self.root = root
        self.jdherb = parse_julian(lines.pop(0))
...
class YearLoopCroplandAnnualFallowBurn(ScenarioBase):
    def __init__(self, lines, root):
        self.root = root
        self.jdburn = parse_julian(lines.pop(0))
...
class YearLoopCroplandAnnualFallowSillage(ScenarioBase):
    def __init__(self, lines, root):
        self.root = root
        self.jdslge = parse_julian(lines.pop(0))
...
class YearLoopCroplandAnnualFallowCut(ScenarioBase):
    def __init__(self, lines, root):
        self.root = root
        self.jdcut = parse_julian(lines.pop(0))
...
class YearLoopCroplandAnnualFallowRemove(ScenarioBase):
    def __init__(self, lines, root):
        self.root = root
        self.jdmove = parse_julian(lines.pop(0))
...
class YearLoopCroplandAnnualFallow(ScenarioBase):
    def __init__(self, lines, root):
        self.root = root
        self.jdharv = parse_julian(lines.pop(0))
        self.jdplt = parse_julian(lines.pop(0))
...
class YearLoopCroplandPerennialCut(ScenarioBase):
    def __init__(self, lines, root):
        self.root = root
        self.cutday = parse_julian(lines.pop(0))
...
class YearLoopCroplandPerennialGraze(ScenarioBase):
    def __init__(self, lines, root):
        ...
        self.gday = parse_julian(lines.pop(0))
        
        self.gend = parse_julian(lines.pop(0))
...
class YearLoopCroplandPerennial(ScenarioBase):
    def __init__(self, lines, root):
        ...
        self.jdharv = parse_julian(lines.pop(0))
        self.jdplt = parse_julian(lines.pop(0))
        self.jdstop = parse_julian(lines.pop(0))
        self.rw = float(lines.pop(0))
...
class YearLoopRangelandGrazeLoop(ScenarioBase):
    def __init__(self, lines, root):
        ...
        self.gday = parse_julian(lines.pop(0))
        self.gend = parse_julian(lines.pop(0))
        self.send = parse_julian(lines.pop(0))
        self.ssday = parse_julian(lines.pop(0))
